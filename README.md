...
The action servers continuously stream feedback during execution. The move_to server reports the mover's current position and remaining distance to the goal, while tilt_to and rotate_to report the mover's current angle on the relevant axis.
